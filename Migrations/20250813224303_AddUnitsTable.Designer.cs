...
namespace StokTakip.Migrations
{
    ...
    [Migration("20250813224303_AddUnitsTable")]
            ...
            modelBuilder.Entity("StokTakip.Models.Unit", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2025, 8, 14, 1, 43, 2, 931, DateTimeKind.Local).AddTicks(4979),
                            Description = "Adet olarak ölçü birimi",
                            Name = "Adet"
                        },
                        new
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2025, 8, 14, 1, 43, 2, 933, DateTimeKind.Local).AddTicks(403),
                            Description = "Kilogram olarak ölçü birimi",
                            Name = "Kg"
                        },
                        new
                        {
                            Id = 3,
                            CreatedDate = new DateTime(2025, 8, 14, 1, 43, 2, 933, DateTimeKind.Local).AddTicks(416),
                            Description = "Litre olarak ölçü birimi",
                            Name = "Litre"
                        },
                        new
                        {
                            Id = 4,
                            CreatedDate = new DateTime(2025, 8, 14, 1, 43, 2, 933, DateTimeKind.Local).AddTicks(417),
                            Description = "Metre olarak ölçü birimi",
                            Name = "Metre"
                        });
                });
